...
public sealed class ShouldlyResultExtensionsTests
{
    ...
    [Fact]
    public async Task ShouldBeSuccess_ValueTaskOk_ReturnsValue()
    {
        var task = ValueTask.FromResult<Result<int, Error>>(12);
    ...
    [Fact]
    public async Task ShouldBeSuccess_ValueTaskErr_ThrowsWithMessage()
    {
        var task = ValueTask.FromResult<Result<int, Error>>(Error.Error1);
        const string message = "expected success";
    ...
    [Fact]
    public async Task ShouldHaveValue_ValueTaskOk_ReturnsValue()
    {
        var task = ValueTask.FromResult<Result<int, Error>>(13);
    ...
    [Fact]
    public async Task ShouldHaveValue_ValueTaskOk_RunsAssertions()
    {
        var task = ValueTask.FromResult<Result<int, Error>>(14);
        bool called = false;
    ...
    [Fact]
    public async Task ShouldHaveValue_ValueTaskErr_DoesNotRunAssertions()
    {
        var task = ValueTask.FromResult<Result<int, Error>>(Error.Error1);
        bool called = false;
    ...
    [Fact]
    public async Task ShouldHaveValue_ValueTaskOkWrongValue_ThrowsWithMessage()
    {
        var task = ValueTask.FromResult<Result<int, Error>>(15);
        const string message = "wrong value";
    ...
    [Fact]
    public async Task ShouldBeError_ValueTaskErr_ReturnsError()
    {
        var task = ValueTask.FromResult<Result<int, Error>>(Error.Error2);
    ...
    [Fact]
    public async Task ShouldBeError_ValueTaskOk_ThrowsWithMessage()
    {
        var task = ValueTask.FromResult<Result<int, Error>>(17);
        const string message = "expected error";
    ...
    [Fact]
    public async Task ShouldHaveError_ValueTaskErr_ReturnsError()
    {
        var task = ValueTask.FromResult<Result<int, Error>>(Error.Error1);
    ...
    [Fact]
    public async Task ShouldHaveError_ValueTaskErr_RunsAssertions()
    {
        var task = ValueTask.FromResult<Result<int, Error>>(Error.Error2);
        bool called = false;
    ...
    [Fact]
    public async Task ShouldHaveError_ValueTaskOk_DoesNotRunAssertions()
    {
        var task = ValueTask.FromResult<Result<int, Error>>(18);
        bool called = false;
    ...
    [Fact]
    public async Task ShouldHaveError_ValueTaskErrWrongError_ThrowsWithMessage()
    {
        var task = ValueTask.FromResult<Result<int, Error>>(Error.Error1);
        const string message = "wrong error";
